        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('reviews.update', $review->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('autor')) has-error @endif">
                    ...
                    <input type="text" id="autor-field" name="autor" class="form-control" value="{{ is_null(old("autor")) ? \App\User::find($review->user_id)->name : old("autor") }}"/>
                    @if($errors->has("autor"))
                ...
                <div class="form-group @if($errors->has('descricao')) has-error @endif">
                    ...
                    <textarea class="form-control" id="descricao-field" rows="3" name="descricao">{{ is_null(old("descricao")) ? $review->descricao : old("descricao") }}</textarea>
                ...
                <div class="form-group @if($errors->has('nota')) has-error @endif">
                    ...
                    {{ Form::selectRange('nota', 0, 10, $review->nota, ['placeholder' => 'Selecione...', 'class' => 'form-control']) }}
                    @if($errors->has("nota"))
