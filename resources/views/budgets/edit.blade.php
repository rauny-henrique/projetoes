...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Budgets / Edit #{{$budget->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('budgets.update', $budget->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('valor')) has-error @endif">
                    ...
                    <input type="text" id="valor-field" name="valor" class="form-control" value="{{ is_null(old("valor")) ? $budget->valor : old("valor") }}"/>
                       @if($errors->has("valor"))
                    ...
                    <input type="text" id="user_id-field" name="user_id" class="form-control" value="{{ is_null(old("user_id")) ? $budget->user_id : old("user_id") }}"/>
